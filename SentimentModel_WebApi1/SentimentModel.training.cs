...
using Microsoft.ML;
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\stephen.bett\Downloads\product-sales.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Month",outputColumnName:@"Month")      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Month"}))      
                                    .Append(mlContext.Regression.Trainers.LbfgsPoissonRegression(new LbfgsPoissonRegressionTrainer.Options(){L1Regularization=13.44506F,L2Regularization=0.03125F,LabelColumnName=@"ProductSales",FeatureColumnName=@"Features"}));
